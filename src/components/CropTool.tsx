...
export default function CropTool() {
  ...
  // Once image loads, init crop to full image
  ...
  // Convert crop to display coords
  const displayCrop = {
    x: crop.x * scaleX,
    y: crop.y * scaleY,
    w: crop.w * scaleX,
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h2 className="font-heading text-2xl font-bold text-foreground">Recadrage</h2>
        <p className="text-muted-foreground text-sm">Recadrez vos images avec des ratios prédéfinis ou en mode libre</p>
      </div>
        ...
        <>
          ...
          <div className="glass rounded-xl overflow-hidden p-2">
            ...
            >
              ...
              {/* Overlay darkened areas */}
              {displayDims.w > 0 && (
                <>
                  {/* Top */}
                  <div className="absolute bg-black/50 pointer-events-none" style={{
                    top: 0, left: 0, width: displayDims.w, height: displayCrop.y,
                  }} />
                  {/* Bottom */}
                  <div className="absolute bg-black/50 pointer-events-none" style={{
                    top: displayCrop.y + displayCrop.h, left: 0, width: displayDims.w,
                    height: displayDims.h - displayCrop.y - displayCrop.h,
                  }} />
                  {/* Left */}
                  <div className="absolute bg-black/50 pointer-events-none" style={{
                    top: displayCrop.y, left: 0, width: displayCrop.x, height: displayCrop.h,
                  }} />
                  {/* Right */}
                  <div className="absolute bg-black/50 pointer-events-none" style={{
                    top: displayCrop.y, left: displayCrop.x + displayCrop.w,
                    width: displayDims.w - displayCrop.x - displayCrop.w, height: displayCrop.h,
                  }} />
                  ...
                  <div
                    ...
                    style={{
                      top: displayCrop.y, left: displayCrop.x,
                      width: displayCrop.w, height: displayCrop.h,
                    }}
